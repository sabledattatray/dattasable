...
export function middleware(request: NextRequest) {
  ...
  const cspHeader = `
    default-src 'self';
    connect-src 'self' https://*.google.com https://accounts.google.com https://*.tableau.com https://*.google-analytics.com https://*.adtrafficquality.google https://*.doubleclick.net https://*.google https://*.google.ad;
    ...
    img-src 'self' blob: data: https://*.unsplash.com https://images.unsplash.com https://*.googleusercontent.com https://*.tableau.com https://lookerstudio.google.com https://datastudio.google.com https://*.google.com https://*.google-analytics.com https://*.googletagmanager.com https://pagead2.googlesyndication.com https://*.doubleclick.net https://*.adtrafficquality.google;
    font-src 'self' https://fonts.gstatic.com https://cdnjs.cloudflare.com;
    frame-src 'self' https://*.youtube.com https://*.youtube-nocookie.com https://*.tableau.com https://*.powerbi.com https://lookerstudio.google.com https://datastudio.google.com https://*.google.com https://*.doubleclick.net https://*.google.ad https://*.google https://*.adtrafficquality.google;
    object-src 'none';
    base-uri 'self';
    form-action 'self';
