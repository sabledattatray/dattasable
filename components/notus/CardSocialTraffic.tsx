...
export default function CardSocialTraffic() {
  const data = [
    { name: "Google", visitors: "1,480", percent: 60, color: "bg-red-500" },
    { name: "Facebook", visitors: "5,480", percent: 70, color: "bg-blue-500" },
    { name: "Instagram", visitors: "4,807", percent: 80, color: "bg-pink-500" },
    { name: "LinkedIn", visitors: "3,352", percent: 75, color: "bg-blue-400" },
    { name: "Twitter", visitors: "2,645", percent: 30, color: "bg-sky-400" },
  ];
