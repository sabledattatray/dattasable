...
const megaMenuData: Record<string, any> = {
  Services: {
    items: [
      ...
      { title: 'Synthetic Data Forge', desc: 'High-fidelity dataset generation.', icon: <Database size={20} style={{ color: '#c9f31d' }} />, href: '/data-forge' },
      ...
      >
        <div className="w-full max-w-[1448px] lg:px-0" style={{ paddingLeft: '1rem', paddingRight: '1rem' }}>
          <div className="flex items-center justify-between h-16 lg:h-20">
            {/* Logo */}
            <Link href="/" aria-label="Datta Sable - Home" className="flex items-center gap-1.5 group whitespace-nowrap flex-shrink-0" style={{ textDecoration: 'none' }}>
