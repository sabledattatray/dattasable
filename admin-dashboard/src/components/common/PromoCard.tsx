        ...
        <Stack direction="column" spacing={2} sx={{ alignItems: "center", position: "relative", zIndex: 10 }}>
          <Stack direction="column" sx={{ alignItems: "center" }} spacing={0.5}>
            ...
            <Stack spacing={1} sx={{ alignItems: "center" }}>
              <Typography variant="caption" sx={{ fontWeight: 500, lineHeight: 1.3 }} color="textPrimary">
                {subTitle}
              </Typography>
          ...
          <Box component="figure" sx={{ m: 0, ...imgStyles }}>
            <Image alt="Datta Sable dashboard" src={img} sx={{ width: 1, height: 1 }} />
          </Box>

          {showFeatures && (
            <Stack direction="column" spacing={0.25} sx={{ alignSelf: "flex-start" }}>
              {proFeatures.map((feature, index) => (
                <Stack key={index} spacing={0.4} sx={{ alignItems: "center" }}>
                  <IconifyIcon
