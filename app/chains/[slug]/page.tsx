...
function ChainExecutionContent() {
...
export default function ChainExecutionPage() {
  return (
    <div style={{ background: 'var(--bg)', minHeight: '100vh' }}>
      <Navbar />
      <Suspense fallback={<div className="container py-20 mono text-xs animate-pulse">ORCHESTRATING_CHAIN_NODES...</div>}>
        <ChainExecutionContent />
      </Suspense>
      <Footer />
    </div>
  );
