      ...
      <div className="grid grid-cols-1 xl:grid-cols-12 gap-8 flex-1">
        ...
        <div className="xl:col-span-8 space-y-8 flex flex-col">
          ...
          >
            ...
            {/* Success Overlay / Live Preview */}
            <AnimatePresence>
              {resultUrl && (
                <motion.div 
                  initial={{ opacity: 0 }}
                  animate={{ opacity: 1 }}
                  className="absolute inset-0 bg-black/90 backdrop-blur-xl z-20 flex flex-col items-center justify-center p-8 text-center"
                >
                  <div className="flex items-center justify-between w-full mb-6 px-4">
                    <div className="flex items-center gap-3">
                      ...
                      <div className="text-left">
                        <h2 className="text-xl font-black tracking-tighter uppercase italic leading-none">Live Insight Deck</h2>
                        <p className="text-[9px] text-gray-500 font-mono uppercase tracking-widest mt-1">Surgical View: Active</p>
                      </div>
                    </div>
                    ...
                    <div className="flex gap-2">
                      <button 
                        ...
                        className="h-10 px-4 bg-[#00f2ff] text-black font-black uppercase rounded-lg flex items-center justify-center gap-2 hover:scale-[1.02] transition-all text-[10px]"
                      >
                      ...
                      <button 
                        ...
                        className="h-10 px-4 bg-white/5 hover:bg-white/10 border border-white/10 rounded-lg flex items-center justify-center transition-all text-[10px] text-gray-400"
                      >
                        Reset
                      </button>
                    </div>
                  ...
                  <div className="flex-1 w-full rounded-2xl overflow-hidden border border-white/10 bg-black/40 relative">
                    {isProcessing && (
                      <div className="absolute inset-0 bg-black/60 backdrop-blur-sm z-30 flex flex-col items-center justify-center">
                         <Loader2 className="w-8 h-8 text-[#00f2ff] animate-spin mb-4" />
                         <div className="text-[10px] font-black uppercase tracking-widest text-[#00f2ff]">Re-Forging Dashboard...</div>
                      </div>
                    )}
                    <iframe 
                      key={resultUrl}
                      ...
                      title="Surgical Dashboard Preview"
                    />
                  </div>
                </motion.div>
              )}
